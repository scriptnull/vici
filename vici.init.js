    ...
    callback: function (err, yml) {
      ...
      vici.config.server = {
        ...
        callback: function (err, server) {
          ...
          console.log('Here are somethings to help you.')
          console.log('***************************************')
          console.log('module - vici.yml')
          console.log('vici yml path - ' + vici.config.yml.viciYmlPath)
          console.log()
          console.log('module - vici.server')
